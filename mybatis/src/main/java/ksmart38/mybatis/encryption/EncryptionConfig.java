...
public class EncryptionConfig {
	...
	public StringEncryptor stringEncryptor() {
		PooledPBEStringEncryptor pooledPBEStringEncryptorEncryptor 
		...
		pooledPBEStringEncryptorEncryptor.setConfig(stringPBEConfig);
       
		
		return pooledPBEStringEncryptorEncryptor;
	}
}
